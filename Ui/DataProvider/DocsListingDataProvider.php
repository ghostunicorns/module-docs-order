...
class DocsListingDataProvider implements DataProviderInterface
{
    ...
    protected function prepareUpdateUrl()
    {
        ...
        foreach ($this->data['config']['filter_url_params'] as $paramName => $paramValue) {
            ...
            if ($paramName == 'entity_id') {
                $paramValue = $this->request->getParam('order_id');
            }
    ...
    {
        $value = $this->request->getParam('order_id') ?: $this->request->getParam('entity_id');
